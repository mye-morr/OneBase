<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="NonSched.aspx.cs" Inherits="OneBase.NonSched" %>
        ...
        <asp:GridView ID="GridView2" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="cat">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtCat" runat="server" Text='<%# Bind ("cat") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblCat" runat="server" Text='<%# Eval("cat") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="subcat">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSubcat" runat="server" Text='<%# Bind ("subcat") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblSubcat" runat="server" Text='<%# Eval("subcat") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="wtcat">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtWtcat" runat="server" Text='<%# Bind ("wtcat") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblWtcat" runat="server" Text='<%# Eval("wtcat") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="subsub">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSubsub" runat="server" Text='<%# Bind ("subsub") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblSubsub" runat="server" Text='<%# Eval("subsub") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="iprio">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtIprio" runat="server" Text='<%# Bind ("iprio") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblIprio" runat="server" Text='<%# Eval("iprio") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="abbrev">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtAbbrev" runat="server" Text='<%# Bind ("abbrev") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblAbbrev" runat="server" Text='<%# Eval("abbrev") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
       ...
       <%-- added later--%>     
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="cat">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Cat" runat="server" Text='<%# Bind ("cat") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Cat" runat="server" Text='<%# Eval("cat") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="subcat">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Subcat" runat="server" Text='<%# Bind ("subcat") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Subcat" runat="server" Text='<%# Eval("subcat") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="wtcat">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Wtcat" runat="server" Text='<%# Bind ("wtcat") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Wtcat" runat="server" Text='<%# Eval("wtcat") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="subsub">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Subsub" runat="server" Text='<%# Bind ("subsub") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Subsub" runat="server" Text='<%# Eval("subsub") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="iprio">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Iprio" runat="server" Text='<%# Bind ("iprio") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Iprio" runat="server" Text='<%# Eval("iprio") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="name">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Name" runat="server" Text='<%# Bind ("name") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Name" runat="server" Text='<%# Eval("name") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="abbrev">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Abbrev" runat="server" Text='<%# Bind ("abbrev") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Abbrev" runat="server" Text='<%# Eval("abbrev") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="content">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Content" runat="server" Text='<%# Bind ("content") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Content" runat="server" Text='<%# Eval("content") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="notes">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2Notes" runat="server" Text='<%# Bind ("notes") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2Notes" runat="server" Text='<%# Eval("notes") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <EditRowStyle BackColor="#999999" />
