<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="_id.aspx.cs" Inherits="OneBase._id" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView2" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="sImpDets">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSImpDets" runat="server" Text='<%# Bind ("sImpDets") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblSImpDets" runat="server" Text='<%# Eval("sImpDets") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="sDtTimStr">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSDtTimStr" runat="server" Text='<%# Bind ("sDtTimStr") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblSDtTimStr" runat="server" Text='<%# Eval("sDtTimStr") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="sTimEnd">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSTimEnd" runat="server" Text='<%# Bind ("sTimEnd") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblSTimEnd" runat="server" Text='<%# Eval("sTimEnd") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
       ...
       <%-- added later--%>     
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="sImpDets">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2SImpDets" runat="server" Text='<%# Bind ("sImpDets") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2SImpDets" runat="server" Text='<%# Eval("sImpDets") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="sDtTimStr">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2SDtTimStr" runat="server" Text='<%# Bind ("sDtTimStr") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2SDtTimStr" runat="server" Text='<%# Eval("sDtTimStr") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="sTimEnd">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt2STimEnd" runat="server" Text='<%# Bind ("sTimEnd") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lbl2STimEnd" runat="server" Text='<%# Eval("sTimEnd") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <EditRowStyle BackColor="#999999" />
